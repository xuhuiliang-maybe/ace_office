...
@class_view_decorator(permission_required('contract_manage.change_contractoutsourc', raise_exception=True))
class ContractOutsourcUpdate(SuccessMessageMixin, UpdateView):
	...
	def get_context_data(self, **kwargs):
		context = super(ContractOutsourcUpdate, self).get_context_data(**kwargs)
		context["form_content"] = u"合同签订-外派"
	...
	def form_valid(self, form):
		...
		return super(ContractOutsourcUpdate, self).form_valid(form)
