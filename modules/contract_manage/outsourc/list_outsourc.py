...
@class_view_decorator(permission_required('contract_manage.browse_contractoutsourc', raise_exception=True))
class ContractOutsourcListView(ListView):
	context_object_name = "contract_outsourc_list"
	template_name = "outsourc_list.html"
	allow_empty = True
	...
	def get_queryset(self):
		try:
			...
			return ContractOutsourc.objects.filter(**kwargs)
		except:
			traceback.print_exc()

	def get_context_data(self, **kwargs):
		context = super(ContractOutsourcListView, self).get_context_data(**kwargs)
