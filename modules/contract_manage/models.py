...
class ContractSend(Contract):
    ...
    def get_absolute_url():
        return reverse("contract:list_send", args=())
...
class ContractOutsourc(Contract):
    ...
    @staticmethod
    def get_absolute_url():
        return reverse("contract:list_outsourc", args=())
...
class ContractIntern(Contract):
    ...
    @staticmethod
    def get_absolute_url():
        return reverse("contract:list_intern", args=())
...
class ContractService(Contract):
    ...
    @staticmethod
    def get_absolute_url():
        return reverse("contract:list_service", args=())
...
class ContractHourly(Contract):
    ...
    @staticmethod
    def get_absolute_url():
        return reverse("contract:list_hourly", args=())
...
class ContractPreviewCode(models.Model):
    ...
    @staticmethod
    def get_absolute_url():
        return reverse("contract:list_contractpreviewcode", args=())
