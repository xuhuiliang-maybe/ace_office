...
@class_view_decorator(permission_required('contract_manage.browse_contracthourly', raise_exception=True))
class ContractHourlyListView(ListView):
	context_object_name = "contract_hourly_list"
	template_name = "hourly_list.html"
	allow_empty = True
	...
	def get_queryset(self):
		try:
			...
			return ContractHourly.objects.filter(**kwargs)
		except:
			traceback.print_exc()

	def get_context_data(self, **kwargs):
		context = super(ContractHourlyListView, self).get_context_data(**kwargs)
