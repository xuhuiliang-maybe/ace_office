...
@class_view_decorator(permission_required('contract_manage.add_contractintern', raise_exception=True))
class ContractInternCreate(SuccessMessageMixin, CreateView):
	form_class = ContractInternForm
	template_name = "contract_edit.html"
	success_message = u"%(name)s 创建成功"

	def get_context_data(self, **kwargs):
		context = super(ContractInternCreate, self).get_context_data(**kwargs)
	...
	def form_valid(self, form):
		...
		return super(ContractInternCreate, self).form_valid(form)
