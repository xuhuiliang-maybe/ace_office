...
@class_view_decorator(permission_required('contract_manage.browse_contractintern', raise_exception=True))
class ContractInternListView(ListView):
	context_object_name = "contract_intern_list"
	template_name = "intern_list.html"
	allow_empty = True
	...
	def get_queryset(self):
		try:
			...
			return ContractIntern.objects.filter(**kwargs)
		except:
			traceback.print_exc()

	def get_context_data(self, **kwargs):
		context = super(ContractInternListView, self).get_context_data(**kwargs)
