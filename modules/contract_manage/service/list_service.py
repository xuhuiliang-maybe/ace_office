...
@class_view_decorator(permission_required('contract_manage.browse_contractservice', raise_exception=True))
class ContractServiceListView(ListView):
	context_object_name = "contract_service_list"
	...
	def get_queryset(self):
		try:
			...
			return ContractService.objects.filter(**kwargs)
		except:
			traceback.print_exc()

	def get_context_data(self, **kwargs):
		context = super(ContractServiceListView, self).get_context_data(**kwargs)
