...
@class_view_decorator(permission_required('social_security_audit.add_socialsecurityaudit', raise_exception=True))
class SocialSecurityAuditCreate(SuccessMessageMixin, CreateView):
	...
	def get_context_data(self, **kwargs):
		context = super(SocialSecurityAuditCreate, self).get_context_data(**kwargs)
		context["form_content"] = u"新增社保审核"
	...
	def form_valid(self, form):
		...
		return super(SocialSecurityAuditCreate, self).form_valid(form)
