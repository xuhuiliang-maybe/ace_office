...
class SidebarMenusList(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        """
        try:
            return HttpResponse(json.dumps({"data": self.get_menu_list()}), content_type="application/json")
        except:
            traceback.print_exc()
