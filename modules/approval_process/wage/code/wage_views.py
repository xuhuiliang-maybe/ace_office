...
@class_view_decorator(permission_required('wage.browse_wage', raise_exception=True))
class WageListView(ListView):
	...
	def get_queryset(self):
		try:
			...
			return Wage.objects.filter(**kwargs)
		except:
			traceback.print_exc()
	...
	def get_context_data(self, **kwargs):
		...
		context["apply_type"] = "wage"
		context["add_url"] = reverse('approval:wage_add')  # 新增url
