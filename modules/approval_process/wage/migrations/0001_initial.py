    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apply_user', models.ForeignKey(related_name='wage_apply_user', verbose_name='\u7533\u8bf7\u4eba', to=settings.AUTH_USER_MODEL)),
                ('handle_user', models.ForeignKey(related_name='wage_handle_user', verbose_name='\u5ba1\u6279\u4eba', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ['-id'],
                'permissions': (('browse_wage', '\u6d4f\u89c8 \u5de5\u8d44\u4e0e\u804c\u4f4d\u8c03\u6574'),),
                'verbose_name': '\u5de5\u8d44\u4e0e\u804c\u4f4d\u8c03\u6574',
            },
        ),
