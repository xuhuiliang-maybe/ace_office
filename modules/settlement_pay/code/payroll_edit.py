...
@class_view_decorator(permission_required('settlement_pay.change_payroll', raise_exception=True))
@class_view_decorator(check_principal)  # 校验是否负责该项目
class PayrollUpdate(SuccessMessageMixin, UpdateView):
	model = Payroll
	template_name = "payroll_edit.html"
	success_message = u"%(employee)s 成功修改"
	fields = "__all__"
	...
	def get_context_data(self, **kwargs):
		context = super(PayrollUpdate, self).get_context_data(**kwargs)
		context["form_content"] = u"修改结算发薪"
