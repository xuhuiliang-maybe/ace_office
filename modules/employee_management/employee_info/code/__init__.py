# coding=utf-8
employee_head_list = [u'姓名（必填）', u'服务部门', u'身份证号（必填）', u'目前状态(在职/离职)', u'项目名称（必填）', u'银行卡号', u'开户银行',
                      u'开户地', u'部门', u'职务', u'性别(男/女)', u'民族', u'学历', u'出生年月(2016-01-01)', u'员工年龄', u'户口所在地',
...
employee_field_list = ["name", "attribution_dept", "identity_card_number", "status", "project_name",
                       "salary_card_number", "bank_account", "bank_address", "job_dept", "position", "sex", "nation",
                       "education",
...
temporary_head_list = [u"姓名", u"性别", u"身份证号", u"项目名称", u"服务部门", u"招聘人员", u"联系电话", u"开始工作日",
                       u"结束工作日", u"工作天数", u"小时数", u"发放金额", u"发放人", u"发放时间", u"备注1", u"创建时间", u"修改时间"]
temporary_field_list = ["name", "sex", "identity_card_number", "project_name", "attribution_dept",
