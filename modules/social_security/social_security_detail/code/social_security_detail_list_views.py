...
class SocialSecurityDetailListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        kwargs["identity_card_number"] = self.identity_card_number
        kwargs["name"] = self.name
        kwargs["insured_month"] = self.insured_month
        kwargs["customer_service"] = self.customer_service
        kwargs["export_url"] = reverse('social_security_detail:social_security_detail_export')
        return super(SocialSecurityDetailListView, self).get_context_data(**kwargs)
