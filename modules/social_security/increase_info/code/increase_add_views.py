...
@class_view_decorator(permission_required('increase_info.add_increase', raise_exception=True))
class IncreaseCreate(SuccessMessageMixin, CreateView):
	model = Increase
	...
	def get_context_data(self, **kwargs):
		context = super(IncreaseCreate, self).get_context_data(**kwargs)
		context["form_content"] = u"新增增员信息"
	...
	def form_valid(self, form):
		...
		try:
			...
			if not emplyid:
				...
				return super(IncreaseCreate, self).form_invalid(form)
			...
			traceback.print_exc()
		return super(IncreaseCreate, self).form_valid(form)
